...
// }
//
// interface MergeHashesOptions {
// keepRemoved?: boolean | RegExp[]
...
// }
//
// interface NestedObject<Values = string> {
// 	[key: string]: NestedObject<Values> | Values
// }
//
// /**
...
//  */
// function mergeHashes(source: NestedObject, target: NestedObject, options: MergeHashesOptions = {}, resetValues = {}) {
// 	let old = {}
// 	let reset = {}
// 	let mergeCount = 0
// 	let pullCount = 0
...
// 			  {
// 				  ...options,
// 				  fullKeyPrefix: fullKeyPrefix + key + keySeparator
// 			  },
// 			  resetValues[key]
// 			)
...
//
//
// function hasRelatedPluralKey<Source extends object>(rawKey: keyof Source, source: Source) {
// 	return pluralSuffixes.some(
// 	  (suffix) => source[`${rawKey}${suffix}`] !== undefined
// 	)
// }
//
// // TODO: check maybe string is not the type here - maybe regex or something else
...
// }
//
// function makeDefaultSort(pluralSeparator: string) {
// 	return function defaultSort(key1: string, key2: string) {
...
// }
//
// async function tsConfigLoader(filepath: string) {
...
// }
//
// function yamlConfigLoader(filepath: string, content: string) {
...
function unescape(text: string) {
	...
	return text.replace(matchHtmlEntity, (m) => htmlEntities[m as keyof typeof htmlEntities])
}
