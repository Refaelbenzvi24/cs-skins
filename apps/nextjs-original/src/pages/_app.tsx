...
import ToastifyContainer from "../../../nextjs/src/components/ToastifyContainer"
...
export declare type AppPropsType<Router extends NextRouter = NextRouter, PageProps = {}> =
...
} & ReturnType<typeof getInitialProps>["pageProps"]> = (props) => {
	const {
		Component,
		pageProps: {
			           session,
