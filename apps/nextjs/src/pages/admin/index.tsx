...
import { Card, Col, LinkButton, Row, Table, TextField, theme, Typography } from "@acme/ui"
	...
	return (
		<>
			...
			<main className="h-full">
				<Col className="h-full py-[20px] px-10">
					<Row className="px-[30px] justify-between w-full">
